...
import { KycConsentDeleteDialogComponent } from '../delete/kyc-consent-delete-dialog.component';

@Component({
  selector: 'jhi-kyc-consent',
  templateUrl: './kyc-consent.component.html',
  imports: [RouterModule, FormsModule, SharedModule, SortDirective, SortByDirective, FormatMediumDatetimePipe, ItemCountComponent],
})
export class KycConsentComponent implements OnInit {
  ...
  delete(kycConsent: IKycConsent): void {
    const modalRef = this.modalService.open(KycConsentDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.kycConsents.set(dataFromBody);
  }
